...
class CrmServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ContactusService::class, function ($app) {
            return new ContactusService(new SendGridService());
        });
    }
    ...
    {
        view()->share('contactusRequestStatuses'    , ContactusStatuses::getStatuses());
    }
}
