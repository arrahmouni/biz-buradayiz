        ...
        return [
            ...
            'provider_register' => [
                'en' => [
                    ...
                    'meta_description' => 'Join our network: compare paid plans by service category, then start your provider application. Free tier plans are not shown here.',
                    'meta_keywords' => 'Biz Buradayiz provider signup, roadside partner application, towing provider plans, provider registration',
                    'og_title' => 'Become a provider — Biz Buradayiz',
                    'og_description' => 'See plans for your category and apply to offer roadside services through our network.',
                    'robots' => 'noindex, nofollow',
                ],
                'tr' => [
                    'meta_title' => 'Hizmet Sağlayıcı Olun | Biz Buradayız',
                    'meta_description' => 'Ağımıza katılın: hizmet kategorinize göre ücretli planları karşılaştırın ve başvurunuzu başlatın.',
                    'meta_keywords' => 'Biz Buradayız sağlayıcı kayıt, yol yardımı planları, çekici başvurusu, sağlayıcı paketleri',
                    'og_title' => 'Sağlayıcı olun — Biz Buradayız',
                    'og_description' => 'Kategorinize uygun planları görün ve ağımız üzerinden yol yardımı sunmak için başvurun.',
                    'robots' => 'noindex, nofollow',
                ],
            ],
            'provider_register_apply' => [
                'en' => [
                    'meta_title' => 'Provider Application | Biz Buradayiz',
                    'meta_description' => 'Submit your details for review. You can sign in after approval.',
                    'meta_keywords' => 'Biz Buradayiz provider application form, service provider signup',
                    'og_title' => 'Complete your provider application',
                    'og_description' => 'Submit your details for review. You can sign in after approval.',
                    'robots' => 'noindex, nofollow',
                ],
                'tr' => [
                    'meta_title' => 'Sağlayıcı Başvurusu | Biz Buradayız',
                    'meta_description' => 'İnceleme için bilgilerinizi gönderin. Onaydan sonra giriş yapabilirsiniz.',
                    'meta_keywords' => 'Biz Buradayız sağlayıcı başvuru formu, hizmet sağlayıcı kayıt',
                    'og_title' => 'Sağlayıcı başvurunuzu tamamlayın',
                    'og_description' => 'İnceleme için bilgilerinizi gönderin. Onaydan sonra giriş yapabilirsiniz.',
                    'robots' => 'noindex, nofollow',
                ],
            ],
