...
return [
    ...
    'package_subscriptions_crud' => [
        ...
        'service_provider' => [
            ...
            'subText' => 'Süresi dolmamış, ödenmiş ve kalan bağlantısı olan aktif aboneliği bulunan sağlayıcılara bu formdan ikinci bir abonelik eklenemez.',
        ],
        ...
        'snapshot_package' => [
            'label' => 'Paket (sipariş anındaki)',
        ],
        'snapshot_price' => [
            'label' => 'Fiyat (sipariş anındaki)',
        ],
        'replace_from_catalog' => [
            'label' => 'Katalogdan satırı yenile',
            'placeholder' => 'İsteğe bağlı — ad ve fiyatı güncellemek için paket seçin',
            'subText' => 'Boş bırakırsanız sipariş özeti değişmez. Paket seçilirse kayıtlı ad, fiyat, para birimi, faturalama dönemi ve bağlantı kotası kayıt sırasında katalogdan yenilenir.',
        ],
        'status' => [
        ...
        'remaining_connections' => [
            'label' => 'Kalan bağlantılar',
            'subText' => 'Sipariş oluşturulurken paket kotasından alınır. “Katalogdan satırı yenile” seçip kaydettiğinizde yeni paketin kotasına güncellenir.',
        ],
        'admin_notes' => [
