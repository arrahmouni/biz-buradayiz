...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create(Models::table('ability_groups'), function (Blueprint $table) {
        ...
        Schema::create(Models::table('ability_group_translations'), function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->foreignId('ability_group_id')->constrained('ability_groups', 'id')->cascadeOnDelete()->cascadeOnUpdate();
            $table->char('locale', 4);
            $table->string('title')->nullable();
            $table->text('description')->nullable();

            $table->unique(['ability_group_id', 'locale']);
        });
        ...
        Schema::create(Models::table('ability_translations'), function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->foreignId('ability_id')->constrained('abilities', 'id')->cascadeOnDelete()->cascadeOnUpdate();
            $table->char('locale', 4);
            $table->string('title')->nullable();
            $table->text('description')->nullable();
    ...
    public function down()
    {
        ...
        Schema::drop(Models::table('ability_group_translations'));
        Schema::drop(Models::table('ability_groups'));
    }
};
