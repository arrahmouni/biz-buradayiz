...
// Package subscription (order) Crud Section
Route::prefix('package-subscriptions')->name('package_subscriptions.')->controller(PackageSubscriptionController::class)->group(function () {
    Route::get('service-provider-preview/{user}', 'serviceProviderPreview')->name('service_provider_preview')->whereNumber('user');
    Route::get('list', 'index')->name('index');
    Route::get('datatable', 'datatable')->name('datatable');
    Route::get('ajax-list', 'ajaxList')->name('ajaxList');
    Route::get('create', 'create')->name('create');
