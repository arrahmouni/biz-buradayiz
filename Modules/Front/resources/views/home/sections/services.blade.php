@if(! empty($frontPublicServices))
    <section id="services" class="py-16 md:py-24 bg-gray-50">
        <div class="container mx-auto px-5 lg:px-8">
            <div class="text-center max-w-2xl mx-auto mb-14 js-front-reveal front-reveal">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 js-front-reveal-group front-reveal-group">
                @foreach($frontPublicServices as $service)
                    <a
                        href="{{ route('front.search', ['service_id' => $service['id']]) }}"
                        class="bg-white rounded-2xl p-5 text-center shadow-sm hover:shadow-xl transition-all duration-300 service-card block no-underline text-inherit focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 front-reveal-child"
                    >
