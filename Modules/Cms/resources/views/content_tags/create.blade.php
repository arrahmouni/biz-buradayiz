@extends('admin::layouts.master', ['title' => trans('admin::cruds.content_tags.add')])
...
@section('toolbar')
    @include('admin::includes.toolbar', [
        'options'                   => [
            ...
            'createUrl'             => route('cms.content_tags.create'),
            'actions'               => [
                'save'              => true,
            ...
            <div class="col-xxl-6 col-12">
                <div class="card card-bordered mb-5">
                    <div class="card-header">
                        <h3 class="card-title">
                            @lang('admin::cruds.content_tags.add')
                        </h3>
                    </div>
                    <div class="card-body">
                        @component('admin::components.forms.form', [
                                'options'       => [
                                    'isAjax'    => true,
                                    'action'    => route('cms.content_tags.postCreate'),
                                ]
                            ])
                            @slot('fields')
