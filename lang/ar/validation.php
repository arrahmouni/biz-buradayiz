...
return [
    ...
    */
    ...
    'custom'                => [
        ...
        'ability_types.*'   => [
            'required'      => 'يجب اختيار نوع واحد على الأقل.',
        ],
        'ability_code.*'    => [
            'unique'        => 'هذا الصلاحية موجودة بالفعل.',
        ],
    ],
    ...
    */
    ...
    'attributes'                                        => [
        'message'                                       => 'الرسالة',
        'image.en'                                      => 'الصورة باللغة الإنجليزية',
        'image.ar'                                      => 'الصورة باللغة العربية',
        'ability_types'                                 => 'أنواع الصلاحيات',
        'name'                                          => 'الاسم',
