    ...
    'paths' => [
        ...
        */
        'generator' => [ 
            ...
            'service' => ['path' => 'app/Http/Services' , 'generate' => false],
            'scopes' => ['path' => 'app/Models/Scopes', 'generate' => false],
            'traits' => ['path' => 'app/Traits', 'generate' => false],

            // app/Http/
            'controller' => ['path' => 'app/Http/Controllers/Admin'  , 'generate' => false],
            ...
            // perms
            'permission' => ['path' => 'app/Enums/permissions'       , 'generate' => false],
        ],
    ],
